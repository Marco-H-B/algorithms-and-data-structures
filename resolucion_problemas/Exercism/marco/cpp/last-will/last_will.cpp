...
namespace estate_executor {
    ...
    int assemble_code() {
        int addBlue, addRed, integer;

        addBlue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        addRed = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();

        integer = addBlue * addRed;
        return integer;
    };
} // namespace estate_executor